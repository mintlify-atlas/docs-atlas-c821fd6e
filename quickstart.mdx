...
<Note>
  You need at least one AI API key configured for the app to work. Both providers can be used simultaneously if both keys are provided.
</Note>
...
<Steps>
  <Step title="Clone and Install Dependencies">
    ...
    - Anthropic and OpenAI SDKs for AI integration
  ...
  <Step title="Configure Environment Variables">
    ...
    <CodeGroup>
      ...
      ```env AI Provider Keys (At least one required)
...
<Steps>
  ...
  <Step title="Generate Handoff Notes from Record">
    ...
    1. **Select AI Provider**: Choose Claude or OpenAI from the dropdown
    2. **Click "Generate from Record"**: The AI will analyze the patient data
    3. **Wait for Generation**: Takes 3-5 seconds
    4. **Review the Notes**: AI generates structured handoff including:
...
Make sure you have added at least one AI API key to your `.env` file:
